...
* In case of technical problems, the course instructor will be on standby **from 09:00 AM to 11:00 AM** on the [Discord](https://study.cs.helsinki.fi/discord/join/ohjelmointi21) at channel `ohjelmointi21_english`.
...
5. Select the course `Introduction to Programming exam 26.10.2021`.
...
* Choose course `Introduction to Programming exam 26.10.2021`.
* If you have been granted extra time through special arrangements, choose course `Introduction to Programming exam 26.10.2021 (EXTRA TIME)`.
...
* You can check the arrival of the exercises you have submitted to the server by logging in to the page [https://tmc.mooc.fi/org/hy/courses/924](https://tmc.mooc.fi/login?return_to=%2Forg%2Fhy%2Fcourses%2F924)
